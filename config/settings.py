...
SECRET_KEY = 'django-insecure-!p5(=^nt4^2@f@aj$o6o@0979tqco8#==xc8ut@hj%i_xfpf+y'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny', #qualquer um pode criar um cadastro de paciente
    ],
}
